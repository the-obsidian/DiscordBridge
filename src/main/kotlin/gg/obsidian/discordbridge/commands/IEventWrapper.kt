...
interface IEventWrapper {
     ...
     *
     * For MessageWrapper instances, this calls getContent()
     *
     ...
     *
     * For MessageWrapper instances, this calls getRawContent()
     *
     ...
     *
     * For MessageWrapper instances, this will return a mention tag in the form <@##########>
     *
     ...
     *
     * For MessageWrapper instances, this returns the origin channel or private channel of the message
     *
     ...
     *
     * For MessageWrapper instances, this returns the author's Discord ID
     *
     ...
     *
     * For MessageWrapper instances, this is true if the inner event's getChannel() is equal to
